...
export const OPTIONAL_LIVE_CHANNELS: LiveChannel[] = [
  ...
  { id: 'yahoo', name: 'Yahoo Finance', handle: '@YahooFinance', fallbackVideoId: 'KQp-e_XQnDE' },
  { id: 'cnn', name: 'CNN', handle: '@CNN', fallbackVideoId: 'w_Ma8oQLmSM' },
  { id: 'livenow-fox', name: 'Fox News', handle: '@FoxNews', fallbackVideoId: 'QaftgYkG-ek' },
  { id: 'newsmax', name: 'Newsmax', handle: '@NEWSMAX', fallbackVideoId: 'S-lFBzloL2Y', useFallbackOnly: true },
  { id: 'abc-news', name: 'ABC News', handle: '@ABCNews', fallbackVideoId: 'NP_NP86nB7Y' },
  ...
  { id: 'tv-rain', name: 'TV Rain', handle: '@tvrain', fallbackVideoId: '8fL_P_O86S3' },
  { id: 'rt', name: 'RT', handle: '', fallbackVideoId: 'V0I5eglZ5js' },
  ...
  { id: 'jovem-pan', name: 'Jovem Pan News', handle: '@jovempannews', fallbackVideoId: 'g3L5S5S5S5S' },
  { id: 'record-news', name: 'Record News', handle: '@RecordNews', fallbackVideoId: '_A6Yp999999' },
  { id: 'band-jornalismo', name: 'Band Jornalismo', handle: '@BandJornalismo', fallbackVideoId: 'w_Ma8oQLmSM' },
  ...
  { id: 'milenio', name: 'MILENIO', handle: '@MILENIO', fallbackVideoId: 'w_Ma8oQLmSM' },
  { id: 'noticias-caracol', name: 'Noticias Caracol', handle: '@NoticiasCaracol', fallbackVideoId: 'w_Ma8oQLmSM' },
  { id: 'ntn24', name: 'NTN24', handle: '@NTN24', fallbackVideoId: 'w_Ma8oQLmSM' },
  { id: 't13', name: 'T13', handle: '@Teletrece', fallbackVideoId: 'w_Ma8oQLmSM' },
  // Asia
  { id: 'tbs-news', name: 'TBS NEWS DIG', handle: '@tbsnewsdig', fallbackVideoId: 'aUDm173E8k8' },
  { id: 'ann-news', name: 'ANN News', handle: '@ANNnewsCH', fallbackVideoId: 'w_Ma8oQLmSM' },
  { id: 'ntv-news', name: 'NTV News (Japan)', handle: '@ntv_news', fallbackVideoId: 'w_Ma8oQLmSM' },
  { id: 'cti-news', name: 'CTI News (Taiwan)', handle: '@中天新聞CtiNews', fallbackVideoId: 'w_Ma8oQLmSM' },
  { id: 'wion', name: 'WION', handle: '@WION', fallbackVideoId: 'w_Ma8oQLmSM' },
  { id: 'ndtv', name: 'NDTV 24x7', handle: '@NDTV', fallbackVideoId: 'w_Ma8oQLmSM' },
  ...
  { id: 'arirang-news', name: 'Arirang News', handle: '@ArirangCoKrArirangNEWS', fallbackVideoId: 'w_Ma8oQLmSM' },
  { id: 'india-today', name: 'India Today', handle: '@indiatoday', fallbackVideoId: 'sYZtOFzM78M' },
  { id: 'abp-news', name: 'ABP News', handle: '@ABPNews', fallbackVideoId: 'w_Ma8oQLmSM' },
  ...
  { id: 'iran-intl', name: 'Iran International', handle: '@IranIntl', fallbackVideoId: 'w_Ma8oQLmSM' },
  { id: 'cgtn-arabic', name: 'CGTN Arabic', handle: '@CGTNArabic', fallbackVideoId: 'w_Ma8oQLmSM' },
  ...
  // Africa
  { id: 'africanews', name: 'Africanews', handle: '@africanews', fallbackVideoId: 'w_Ma8oQLmSM' },
  { id: 'channels-tv', name: 'Channels TV', handle: '@ChannelsTelevision', fallbackVideoId: 'w_Ma8oQLmSM' },
  { id: 'ktn-news', name: 'KTN News', handle: '@ktnnews_kenya', fallbackVideoId: 'RmHtsdVb3mo' },
  { id: 'enca', name: 'eNCA', handle: '@encanews', fallbackVideoId: 'w_Ma8oQLmSM' },
  { id: 'sabc-news', name: 'SABC News', handle: '@SABCDigitalNews', fallbackVideoId: 'w_Ma8oQLmSM' },
  ...
  { id: 'tv5monde-info', name: 'TV5 Monde Info', handle: '@TV5MONDEInfo', fallbackVideoId: 'w_Ma8oQLmSM' },
  { id: 'nrk1', name: 'NRK1', handle: '@nrk', fallbackVideoId: 'w_Ma8oQLmSM' },
  { id: 'aljazeera-balkans', name: 'Al Jazeera Balkans', handle: '@AlJazeeraBalkans', fallbackVideoId: 'w_Ma8oQLmSM' },
  // Oceania
...
const _REGION_ENTRIES: { key: string; labelKey: string; channelIds: string[] }[] = [
  { key: 'na', labelKey: 'components.liveNews.regionNorthAmerica', channelIds: ['bloomberg', 'cnbc', 'yahoo', 'cnn', 'livenow-fox', 'newsmax', 'abc-news', 'cbs-news', 'nbc-news', 'cbc-news', 'nasa'] },
...
const DIRECT_HLS_MAP: Readonly<Record<string, string>> = {
  ...
  'livenow-fox': 'https://247preview.foxnews.com/hls/live/2020027/fncv3preview/primary.m3u8',
};
